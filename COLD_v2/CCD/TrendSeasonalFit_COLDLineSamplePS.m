function [rec_cg, clrx, clry] = TrendSeasonalFit_COLDLineSamplePS(sdate, line_t, path_t, path_r, ncols, nrows, proc_cols, T_cg,Tmax_cg,conse,num_c,nbands,B_detect)
...
%     line_t(:,nbands*(i_ids-1)+7) = 10*(line_t(:,nbands*(i_ids-1)+7) - 2732);
    ...
    % ke: PlanetScope only has 4 spectral bands 
