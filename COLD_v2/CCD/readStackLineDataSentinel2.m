function [sdate, line_t, path_t]= readStackLineDataSentinel2(folderpath_row, ncols, nbands, rows, path_r)
...
%     imf = dir(fullfile(folderpath_row, 'L*')); % folder names
    imf = dir(fullfile(folderpath_row,'*S*'));
