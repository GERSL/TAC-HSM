function [rec_cg, clrx, clry] = TrendSeasonalFit_COLDLineSampleHLS_singleBand(sdate, line_t, path_t, path_r, ncols, nrows, proc_cols, T_cg,Tmax_cg,conse,num_c,nbands,B_detect)
...
%                             % end of moving window
        ...
        elseif BL_train == 0
            ...
            % ks 20260129: don't excute Tmask
            % % Tmask
