function [rec_cg, clrx, clry] = TrendSeasonalFit_COLDLineSampleHLS(sdate, line_t, path_t, path_r, ncols, nrows, proc_cols, T_cg,Tmax_cg,conse,num_c,nbands,B_detect)
