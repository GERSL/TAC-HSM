function stackS2ARD2Line(folderpath_ard, folderpath_stack, varargin)
...
% COPYRIGHT @ GERSLab
    ...
    % test path
%     folderpath_ard = '/scratch/kes20012/S2_ARD_CT/T18TXM/';
%     folderpath_ard = '/scratch/kes20012/ARD_Fusion_BRDF/18TYL/';
%     folderpath_stack = '/scratch/kes20012/S2_stack/T18TXM/';
%     folderpath_stack = '/scratch/kes20012/S2_stack_fusion/18TYL/';
...
%         filepath_bt = fullfile(folderpath_ard, [imf, '_BT.tar']);
        ...
        %             cfmask0 = GRIDobj(fullfile(folderpath_tmp, [imf, 'T*mask4*.tif']));
                    dirfmask = dir(fullfile(folderpath_ard, imf, 'T*mask4*.tif'));
        ...
        %             cfmask0 = GRIDobj(fullfile(folderpath_, [imf, 'T*mask4*.tif']));
                ...
                tif_B11 = dir(fullfile(folderpath_ard,imf,'T*B11*.tif'));
                tif_B12 = dir(fullfile(folderpath_ard,imf,'T*B12*.tif'));
                tif_B8A = dir(fullfile(folderpath_ard,imf,'T*B8A*.tif'));

                b1 = geotiffread(fullfile(folderpath_ard, imf, tif_B2.name));
                b2 = geotiffread(fullfile(folderpath_ard, imf, tif_B3.name));
                b3 = geotiffread(fullfile(folderpath_ard, imf, tif_B4.name));
                b4 = geotiffread(fullfile(folderpath_ard, imf, tif_B5.name));
                b5 = geotiffread(fullfile(folderpath_ard, imf, tif_B6.name));
                b6 = geotiffread(fullfile(folderpath_ard, imf, tif_B7.name));
                b7 = geotiffread(fullfile(folderpath_ard, imf, tif_B8.name));
                b8 = geotiffread(fullfile(folderpath_ard, imf, tif_B11.name));
                b9 = geotiffread(fullfile(folderpath_ard, imf, tif_B12.name));
                b10 = geotiffread(fullfile(folderpath_ard, imf, tif_B8A.name));
