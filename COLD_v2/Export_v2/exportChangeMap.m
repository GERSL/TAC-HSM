...
% addpath('/home/kes20012/COLD_v2/CCD/private/GLMnet');
...
% optional
p = inputParser;
addParameter(p,'ctype', true); % label the type of change
addParameter(p,'msg', true); % not to display info
addParameter(p,'sensor','HLS');
parse(p,varargin{:});
msg = p.Results.msg;
...
folderpath_cold = '/scratch/zhz18039/kes20012/COLDHLSv2Results/18TXM';
years = 2015:2021;
...
folderpath_chgmap = fullfile(folderpath_cold, 'ChangeMap');
...
%% get metadata
load(fullfile(folderpath_cold,'StackData1', 'R0000100001','metadata.mat'));
nrows = metadata.nrows;
ncols = metadata.ncols;
% Sentinel-2: 10 spectral bands + 1 QA band
% HLS: 6 spectral bands + 1 QA band
