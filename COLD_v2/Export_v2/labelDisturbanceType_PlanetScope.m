function [dist_type,dist_year,dist_doy]=labelDisturbanceType_PlanetScope(curr_cft,curr_time,t_c,vec,next_cft)
...
%
% ks 20240122: remove swir because PlanetScope doesn't have swir band.
