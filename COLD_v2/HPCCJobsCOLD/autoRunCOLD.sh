...
#SBATCH -o TileName-%A_%a.out
#SBATCH -e TileName-%A_%a.err
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -t 48:00:00
#SBATCH -a 1-TotalCores:1


module load matlab
matlab -nodisplay -singleCompThread -r "cd /home/qiu25856/COLDAuto_CONUS_AppendChangeInterval/; addpath('/home/qiu25856/COLDAuto_CONUS_AppendChangeInterval/'); batchRunCOLDCONUS($SLURM_ARRAY_TASK_ID, $SLURM_ARRAY_TASK_MAX, 'TileName'); exit"
