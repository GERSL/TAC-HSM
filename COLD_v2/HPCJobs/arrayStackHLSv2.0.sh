...
#SBATCH --ntasks 1
#SBATCH --array 1-20
#SBATCH --output stack_HLS2.0_HLS_T18TXM_T18TXL_18TYL.out
...
matlab -nodisplay -nosplash -singleCompThread -r "batchStackHLSv2Line('task',$SLURM_ARRAY_TASK_ID, 'ntasks',$SLURM_ARRAY_TASK_MAX,'ARDTiles','18TXM','resolution',30,'sensor','HLS');exit"
matlab -nodisplay -nosplash -singleCompThread -r "batchStackHLSv2Line('task',$SLURM_ARRAY_TASK_ID, 'ntasks',$SLURM_ARRAY_TASK_MAX,'ARDTiles','18TXL','resolution',30,'sensor','HLS');exit"
matlab -nodisplay -nosplash -singleCompThread -r "batchStackHLSv2Line('task',$SLURM_ARRAY_TASK_ID, 'ntasks',$SLURM_ARRAY_TASK_MAX,'ARDTiles','18TYL','resolution',30,'sensor','HLS');exit"
exit
