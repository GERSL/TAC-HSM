function runTAC_Landsat_allForestPixels(varargin)
%%-----------------------------------------------------
%
%
...
%%-----------------------------------------------------
    ...
    folderpath_TACResults = fullfile(directory,'TACResults_AllForestPixels_2025-08-04',[sensor,'_',composite_interval]);
    % if remove_outliers
    ...
    %% load input data
    filename = fullfile(directory,'Input','random_sample_forest_cover_input.csv');
