function displayRegressionPlot_NIRv_reverse_conseGap1(varargin)
            ...
            switch trait 
                case 'HSM'
                    switch unique_names{ip} 
                        case {'MAN','NVX'}%'ATTO'
                            text(mean_HSM(ip)+0.04,1-mean_TAC(ip)+0.02,unique_names{ip},'fontsize',12);
                        case 'SUC'
                        ...
                        case 'TAM'
                            text(mean_HSM(ip)+0.04,1-mean_TAC(ip)-0.02,unique_names{ip},'fontsize',12);
                        case 'ALP2'
                            text(mean_HSM(ip)-0.1,1-mean_TAC(ip)+0.03,unique_names{ip},'fontsize',12);
                        case 'CAX' 
                            text(mean_HSM(ip)+0.03,1-mean_TAC(ip)-0.03,unique_names{ip},'fontsize',12);
                        case 'FEC'
                ...
                case 'Pmin'
                    switch unique_names{ip} 
                        ...
                        case 'ALP2'
                            text(mean_HSM(ip)-0.1,1-mean_TAC(ip)+0.04,unique_names{ip},'fontsize',12);
