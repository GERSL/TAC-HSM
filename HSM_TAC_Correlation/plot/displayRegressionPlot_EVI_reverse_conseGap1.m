function displayRegressionPlot_EVI_reverse_conseGap1(varargin)
    ...
    if do_plot
        ...
        % scatter(mean_HSM,1-mean_TAC,sz,mean_MCWD,'filled');
        cmap = turbo(64);
        % cmap = flipud(turbo(128));
        colormap(cmap);
        clim([-1800,-300]);
        % clim([-650,0]);
