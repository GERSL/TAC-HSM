function calculateAIC_HSM_OneMinusTAC(varargin)
    ...
    % default_display_ids = [1:53];  % plot ids to analyze
...
% 
        ...
        for iV = 1:length(VIs)
            ...
            for ir = 1:length(rolling_windows_y)
                ...
                for i = 1:length(point_ids)
                    ...
                    if outlier_removed
                        folderpath_TACResults = fullfile(directory,'TACResults_FieldSample_2025-08-02',['Landsat_',composite_interval]);
                    else
                        folderpath_TACResults = fullfile(directory,'TACResults_FieldSample_2025-08-02noOutlierRemoval/',['Landsat_',composite_interval]);
                    end
    ...
    folderpath_output = fullfile(directory,'r_TAC_HSM_2025-09-21',composite_interval);
    ...
    if save_output
        if use_p88
            ...
            save(fullfile(folderpath_output,'HSM_p50_r.mat'),"HSM_p50_r");
            save(fullfile(folderpath_output,'HSM_p50_pValues.mat'),"HSM_p50_pValues");

            save(fullfile(folderpath_output,'HSM_p50_AIC1.mat'),"HSM_p50_AIC1");
            save(fullfile(folderpath_output,'HSM_p50_AIC2.mat'),"HSM_p50_AIC2");

            save(fullfile(folderpath_output,'HSM_p50_R2_mdl1.mat'),"HSM_p50_R2_mdl1");
            save(fullfile(folderpath_output,'HSM_p50_R2_mdl2.mat'),"HSM_p50_R2_mdl2");
        end
    end
