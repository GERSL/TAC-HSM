function prepareResponseVariableFieldSample(varargin)
    warning('off');
            ...
            filename = fullfile(folderpath,'Input',sprintf('%s_input_%dyr.csv', base, rolling_window_y));
                ...
                for i = 1:num_samples
                    ...
                    try
                        ...
                        tac_filename = fullfile(folderpath, 'TACResults_FieldSample_2025-08-02/',['Landsat_',composite_interval], sprintf('TAC_record_change_plot%05d.mat',Plot_Ids(i)));
