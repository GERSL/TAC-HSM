function preparePredictorVariablesFieldSample()
...
% ks 20250810
    ...
    csv_file   = fullfile(folderpath,'Input','Sample_multipleInPlot_HPC.csv');
    ...
    fc_file    = fullfile(folderpath,'ForestCover','Sample_multipleInPlot_forest_cover.csv');
