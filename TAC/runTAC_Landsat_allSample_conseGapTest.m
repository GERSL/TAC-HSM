function runTAC_Landsat_allSample_conseGapTest(varargin)
%%-----------------------------------------------------
%
%
...
% ks 20260115: Add conseGap to test the how does gap-filling strategy
%               impact the TAC estimation.
%
%%-----------------------------------------------------
    % close all;
    ...
    addParameter(p,'conseGap',2);   % default is filling 2 consecutive missings 
    ...
    folderpath_TACResults = fullfile(directory,'TACResults_2025-1-15',[sensor,'_',composite_interval],['conseGap',int2str(conseGap)]);
    % if remove_outliers
    ...
    for i_task = start_i:end_i
        ...
        if fc<10
            ...
            TAC_record_change = autoTAC_sample(sensor,plot_data,'composite_interval',{composite_interval},...
                 ...
                 'plot_name','test','savefig',false,'doplot',false,'plot_VI','EVI2','conse_gap',conse_gap);
