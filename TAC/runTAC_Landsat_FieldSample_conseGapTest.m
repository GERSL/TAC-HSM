function runTAC_Landsat_FieldSample_conseGapTest(varargin)
...
% ks 20250731: Replace to BRDF-corrected surface reflectance
    ...
    sr_files = dir(fullfile(directory,'data','/LandsatData/SurfaceReflectanceAnglesBRDF/','Sample_multipleInPlot_HPC_surface_reflectance_000001_000053_angles_brdf.csv'));
    ...
    % for i_task = 48    % HSF
        ...
        %     'plot_id',id,'plot_lat',lat,'plot_lon',lon,'plot_name',site_name,'savefig',false,'doplot',true,'plot_VI','NIRv','conse_gap',conse_gap);
        % don't plot
        TAC_record_change = autoTAC_sample(sensor,plot_data,'composite_interval',{composite_interval},'VI',{'NDVI','kNDVI','NIRv','NBR','NDMI','EVI','EVI2'},...
