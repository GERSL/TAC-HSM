function checkLandsatDensityFieldSample(varargin)
%%-----------------------------------------------------
%
%
...
%%-----------------------------------------------------
    ...
    folderpath_DensityResults = fullfile(directory,'Supplementary',[sensor,'_FieldSample_density_',composite_interval]);
